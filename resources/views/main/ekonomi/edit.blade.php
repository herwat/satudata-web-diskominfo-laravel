                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('ekonomi.update', $result->id) }}" method="POST"
                                ...
                                <dv class="row">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <label for="file_excel">File excel</label> <br>
                                        {{-- <input type="file" class="form-control" id="file_excel" name="file_excel"
                                            value="{{ $result->file_excel }}"> --}}
                                        <a href="{{ asset('storage/' . $result->file_excel) }}" target="_blank"
                                            rel="noopener noreferrer" class="btn btn-primary btn-block">
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <a href="{{ url('main/ekonomi') }}" class="btn btn-danger btn-block">Kembali</a>
                                    </div>
                                </dv>
                            </form>
                        </div>
