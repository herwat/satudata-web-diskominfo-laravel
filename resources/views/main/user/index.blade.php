...
@section('content')
    <div class="container-fluid" style="padding-left: 1%;">
        <a href="{{ url('main/user/create') }}" class="btn btn-primary">Tambah Data</a>
        {{-- <a href="{{ url('main/user/import') }}" class="btn btn-warning">Import Data</a> --}}
    </div>
    <br>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($result as $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->email }}</td>
                                            <td>
                                                <a href="/main/user/{{ $row->id }}" class="btn btn-primary btn-sm"><i
                                                        class="fa fa-eye"></i></a>
                                                <a href="/main/user/{{ $row->id }}/edit"
