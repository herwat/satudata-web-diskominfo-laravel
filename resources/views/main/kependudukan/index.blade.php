...
@section('content')
    <div class="container-fluid" style="padding-left: 1%;">
        <a href="{{ url('main/kependudukan/create') }}" class="btn btn-primary">Tambah Data</a>
    </div>
    <br>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($result as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/main/kependudukan/{{ $row->id }}/edit"
                                                    class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                                                <form action="{{ route('kependudukan.destroy', $row->id) }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
                                                    @method('delete')
